...
const STATUS_CONFIG: Record<OrderStatus, { label: string; color: string; bg: string }> = {
    ...
    SHIPPED: { label: "Ready (ปรุงเสร็จ/รอรับ)", color: "text-purple-700", bg: "bg-purple-50" }, // Mapping SHIPPED to Ready
    COMPLETED: { label: "Completed (ลูกค้ารับแล้ว)", color: "text-green-700", bg: "bg-green-50" },
